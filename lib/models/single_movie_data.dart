...
//
//     final singleMovieData = singleMovieDataFromJson(jsonString);

import 'dart:convert';

SingleMovieData singleMovieDataFromJson(String str) =>
    SingleMovieData.fromJson(json.decode(str));

String singleMovieDataToJson(SingleMovieData data) =>
...
class SingleMovieData {
  ...
  factory SingleMovieData.fromJson(Map<String, dynamic> json) =>
      SingleMovieData(
